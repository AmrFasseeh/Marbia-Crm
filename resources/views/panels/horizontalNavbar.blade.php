        ...
        <li>
          <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
            ...
            <span class="avatar-status avatar-online">
              <img src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-7.png')}}" alt="avatar">
      ...
      <div class="nav-wrapper">
        <form id="navbarForm">
          <div class="input-field search-input-sm">
            <input class="search-box-sm" type="search" required="" placeholder='Explore Marbia Crm' id="search"
              data-search="template-list">
  ...
  <nav class="white hide-on-med-and-down" id="horizontal-nav">
    <div class="nav-wrapper">
      <ul class="left hide-on-med-and-down" id="ul-horizontal-nav" data-menu="menu-navigation">
        ...
        @endphp
        <li>
          <a class="dropdown-menu" href="{{$menu->url}}" data-target="{{$menu->activate}}">
            <i class="material-icons">{{$menu->icon}}</i>
            <span>
              <span class="dropdown-title" data-i18n="{{$translation}}">{{ __('locale.'.$menu->name)}}</span>
              @isset($menu->submenu)
...
<ul class="display-none" id="default-search-main">
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="{{asset('marbia/marbia-crm/public/images/icon/pdf-image.png')}}" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="{{asset('marbia/marbia-crm/public/images/icon/doc-image.png')}}" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="{{asset('marbia/marbia-crm/public/images/icon/xls-image.png')}}" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img src="{{asset('marbia/marbia-crm/public/images/icon/jpg-image.png')}}" width="24" height="30"
              alt="sample image">
          </div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-7.png')}}" width="30"
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-8.png')}}" width="30"
              alt="sample image"></div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-10.png')}}" width="30"
              alt="sample image"></div>
  ...
  <li class="auto-suggestion"><a class="collection-item" href="#">
      <div class="display-flex">
        <div class="display-flex align-item-center flex-grow-1">
          <div class="avatar"><img class="circle" src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-12.png')}}" width="30"
              alt="sample image"></div>
          <div class="member-info display-flex flex-column"><span class="black-text">Anna Strong</span><small
              class="grey-text">Web Designer</small></div>
        </div>
