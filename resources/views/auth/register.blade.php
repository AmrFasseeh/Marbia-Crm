...
{{-- page style --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/register.css')}}">
@endsection
    ...
    <form class="login-form" method="POST" action="{{ route('register') }}">
      ...
      <div class="row margin">
        <div class="input-field col s12">
          ...
          <label for="username" class="center-align">User Name</label>
          @error('username')
          <small class="red-text ml-10" role="alert">
            {{ $message }}
          </small>
      ...
      <div class="row margin">
        <div class="input-field col s12">
          <i class="material-icons prefix">language_outline</i>
          <select class="icons" name="locale">
            <option value="" disabled selected>Choose your option</option>
            <option value="en" data-icon="flag-icon-gb" class="circle">English</option>
          </select>
