...
{{-- page style --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/lock.css')}}">
@endsection
    ...
    <form class="login-form">
      <div class="row">
        <div class="input-field col s12 center-align mt-10">
          <img class="z-depth-4 circle responsive-img" width="100" src="{{asset('marbia/marbia-crm/public/images/user/4.jpg')}}" alt="">
          <h5>John Doe</h5>
        </div>
      </div>
