...
{{-- page styles --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/page-maintenance.css')}}">
@endsection
...
<div class="section p-0 m-0 height-100vh section-maintenance">
  <div class="row">
    ...
    <div id="maintenance" class="col s12 center-align white">
      <img src="{{asset('marbia/marbia-crm/public/images/gallery/maintenance.png')}}" class="responsive-img maintenance-img" alt="">
