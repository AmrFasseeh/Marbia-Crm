...
{{-- page styles --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('public/css/pages/page-maintenance.css')}}">
@endsection
...
<div class="section p-0 m-0 height-100vh section-maintenance">
  <div class="row">
    ...
    <div id="maintenance" class="col s12 center-align white">
      <img src="{{asset('public/images/gallery/maintenance.png')}}" class="responsive-img maintenance-img" alt="">
      ...
      <a class="btn waves-effect waves-light" href="{{asset('publicecommerce')}}">Back TO Home</a>
    </div>
  </div>
</div>
@endsection