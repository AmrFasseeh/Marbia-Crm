...
<script src="{{asset('marbia/marbia-crm/public/vendors/noUiSlider/nouislider.js')}}"></script>
@endsection

{{-- page script --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/form-elements.js')}}"></script>
@endsection