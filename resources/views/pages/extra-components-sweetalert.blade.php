...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/sweetalert/sweetalert.css')}}">
@endsection
...
{{-- page script --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/extra-components-sweetalert.js')}}"></script>
@endsection