...
{{-- page styles --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/advance-ui-media.css')}}">
@endsection
        ...
        <div class="card-content">
          ...
          <div id="view-material-box">
            <div class="row">
              ...
              <div class="col s12">
                <img class="materialboxed mt-2" src="{{asset('marbia/marbia-crm/public/images/gallery/29.png')}}" alt="sample">
          ...
          <div class="card-title">
            ...
            <div id="view-captions">
              <div class="row">
                ...
                <div class="col s12 mt-2">
                  <img class="materialboxed" width="250" src="{{asset('marbia/marbia-crm/public/images/gallery/21.png')}}" alt="sample"
                ...
                <div class="col s12">
                  ...
                  <div class="slider">
                    <ul class="slides mt-2">
                      <li>
                        <img src="{{asset('marbia/marbia-crm/public/images/gallery/30.png')}}" alt="img-1">
                        <!-- random image -->
                      ...
                      <li>
                        <img src="{{asset('marbia/marbia-crm/public/images/gallery/31.png')}}" alt="img-2">
                        <!-- random image -->
                      ...
                      <li>
                        <img src="{{asset('marbia/marbia-crm/public/images/gallery/33.png')}}" alt="img-3">
                        <!-- random image -->
                      ...
                      <li>
                        <img src="{{asset('marbia/marbia-crm/public/images/gallery/28.png')}}" alt="img-4">
                        <!-- random image -->
                        <div class="caption center-align">
                          <h3 class="white-text">This is our big Tagline!</h3>
                          <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5>
...
{{-- page scripts --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/advance-ui-media.js')}}"></script>
@endsection