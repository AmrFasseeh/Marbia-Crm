...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/css/fullcalendar.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/daygrid/daygrid.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/timegrid/timegrid.min.css')}}">
@endsection

{{-- page styles --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/app-calendar.css')}}">
<style>
...
<script src="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/lib/moment.min.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/js/fullcalendar.min.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/daygrid/daygrid.min.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/timegrid/timegrid.min.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/vendors/fullcalendar/interaction/interaction.min.js')}}"></script>
@endsection
...
<script src="{{asset('marbia/marbia-crm/public/js/scripts/app-calendar.js')}}"></script>
@endsection