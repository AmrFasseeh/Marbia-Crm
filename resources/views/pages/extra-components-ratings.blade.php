...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/rateYo/jquery.rateyo.min.css')}}">
@endsection
...
<script src="{{asset('marbia/marbia-crm/public/vendors/rateYo/jquery.rateyo.min.js')}}"></script>
@endsection

{{-- page script --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/extra-components-ratings.js')}}"></script>
@endsection