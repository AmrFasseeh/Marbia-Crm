...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/shepherd-js/shepherd-theme-default.min.css')}}">
@endsection

{{-- page style --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/extra-components-tour.css')}}">
@endsection
...
<script src="{{asset('marbia/marbia-crm/public/vendors/shepherd-js/shepherd.min.js')}}"></script>
@endsection

{{-- page script --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/extra-components-tour.js')}}"></script>
@endsection