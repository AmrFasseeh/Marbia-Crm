...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/quill/katex.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/quill/monokai-sublime.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/quill/quill.snow.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/quill/quill.bubble.css')}}">
@endsection
...
<script src="{{asset('marbia/marbia-crm/public/vendors/quill/katex.min.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/vendors/quill/highlight.min.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/vendors/quill/quill.min.js')}}"></script>
@endsection

{{-- page script --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/form-editor.js')}}"></script>
@endsection