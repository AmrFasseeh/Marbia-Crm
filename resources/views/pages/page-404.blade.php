...
{{-- page style --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/page-404.css')}}">
@endsection
...
<div class="section section-404 p-0 m-0 height-100vh">
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{asset('marbia/marbia-crm/public/images/gallery/error-2.png')}}" class="bg-image-404" alt="">
