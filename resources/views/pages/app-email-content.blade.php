...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/app-email-content.css')}}">
@endsection
                ...
                <div class="footer-action">
                  <div class="attachment-list">
                    <div class="attachment">
                      <img src="{{asset('marbia/marbia-crm/public/images/gallery/35.png')}}" alt="" class="responsive-img attached-image">
                      <div class="size">
                    ...
                    <div class="attachment">
                      <img src="{{asset('marbia/marbia-crm/public/images/gallery/36.png')}}" alt="" class="responsive-img attached-image">
                      <div class="size">
                    ...
                    <div class="attachment">
                      <img src="{{asset('marbia/marbia-crm/public/images/gallery/39.png')}}" alt="" class="responsive-img attached-image">
                      <div class="size">
...
{{-- page scripts --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/app-email-content.js')}}"></script>
@endsection