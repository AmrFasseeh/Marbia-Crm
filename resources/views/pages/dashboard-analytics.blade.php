         ...
         <div class="col s12 m12 l4">
            <div id="profile-card" class="card animate fadeRight">
               <div class="card-image waves-effect waves-block waves-light">
                  <img class="activator" src="{{asset('marbia/marbia-crm/public/images/gallery/3.png')}}" alt="user bg" />
               </div>
               <div class="card-content">
...
{{-- page scripts --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/dashboard-analytics.js')}}"></script>
@endsection