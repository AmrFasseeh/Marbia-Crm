...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/ionRangeSlider/css/ion.rangeSlider.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/ionRangeSlider/css/ion.rangeSlider.skinFlat.css')}}">
@endsection
...
<script src="{{asset('marbia/marbia-crm/public/vendors/ionRangeSlider/js/ion.rangeSlider.js')}}"></script>
@endsection

{{-- page scripts --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/extra-components-range-slider.js')}}"></script>
@endsection