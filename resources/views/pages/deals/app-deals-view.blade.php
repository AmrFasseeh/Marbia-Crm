        ...
        <div class="row">
            <div class="col s12 m7">
                <div class="display-flex media">
                    {{-- <a href="#" class="avatar">
                        <img src="{{ isset($deal->image) ? $deal->image->url():asset('marbia/marbia-crm/public/images/avatar/default.png') }}"
                    ...
                    <div class="card blue lighten-5">
                        <div class="card-content">
                            <span class="card-title"><img
                                    src="{{ isset($deal->image) ? $deal->image->url():asset('marbia/marbia-crm/public/images/avatar/default.png') }}"
...
<script src="{{asset('marbia/marbia-crm/public/vendors/sweetalert/sweetalert.min.js')}}"></script>
@endsection
{{-- page script --}}
@section('page-script')
{{-- <script src="{{asset('marbia/marbia-crm/public/js/custom/deals-view.js')}}"></script> --}}
<script>
