...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/animate-css/animate.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/chartist-js/chartist.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/vendors/chartist-js/chartist-plugin-tooltip.css')}}">
@endsection

{{-- page styles --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/dashboard-modern.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/intro.css')}}">
@endsection
         ...
         <div class="card recent-buyers-card animate fadeUp">
            <div class="card-content">
               ...
               <ul class="collection mb-0">
                  ...
                  <li class="collection-item avatar">
                     <img src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-3.png')}}" alt="" class="circle" />
                     <p class="font-weight-600">Adam Garza</p>
                     <p class="medium-small">20, January 2019</p>
                     <a href="#!" class="secondary-content"><i class="material-icons">star_border</i></a>
                  </li>
                  <li class="collection-item avatar">
                     <img src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-5.png')}}" alt="" class="circle" />
...
<script src="{{asset('marbia/marbia-crm/public/vendors/chartist-js/chartist-plugin-tooltip.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/vendors/chartist-js/chartist-plugin-fill-donut.min.js')}}"></script>
@endsection

{{-- page scripts --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/dashboard-modern.js')}}"></script>
<script src="{{asset('marbia/marbia-crm/public/js/scripts/intro.js')}}"></script>
@endsection