        ...
        <div class="col s12 m4 l12">
            <div id="basic-form" class="card card card-default scrollspy">
                <div class="card-content">
                    ...
                    <form action="{{ route('update.projectStage', $stage->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="input-field col s6">
                                <input type="text" id="title" name="title" class="@error('title') is-invalid @enderror"
                                    value="{{ $stage->title }}" required autofocus autocomplete="title">
                            ...
                            <div class="input-field col s6">
                                <input type="number" id="num_of_buildings" name="num_of_buildings" class="@error('num_of_buildings') is-invalid @enderror"
                                    value="{{ $stage->num_of_buildings }}" required autocomplete="num_of_buildings">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <input type="text" id="address" name="address" class="@error('address') is-invalid @enderror"
                                    value="{{ $stage->address }}" required autocomplete="address">
                        ...
                        <div class="row">
                            <div class="input-field col s12">
                                <textarea name="description" id="description" class="materialize-textarea">{{ $stage->description }}</textarea>
