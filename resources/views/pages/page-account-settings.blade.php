...
{{-- page style --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/page-account-settings.css')}}">
@endsection
      ...
      <div id="general">
        <div class="card-panel">
          <div class="display-flex">
            <div class="media">
              <img src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-12.png')}}" class="border-radius-4" alt="profile image"
                height="64" width="64">
            </div>
...
{{-- page script --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/page-account-settings.js')}}"></script>
@endsection