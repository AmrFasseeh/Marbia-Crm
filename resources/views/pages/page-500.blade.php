...
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('public/css/pages/page-500.css')}}">
@endsection
...
<div class="section p-0 m-0 height-100vh section-500">
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{asset('public/images/gallery/error-2.png')}}" alt="" class="bg-image-500">
      ...
      <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4"
        href="{{asset('publicecommerce')}}">Back
        TO Home</a>
    </div>
  </div>
</div>
