...
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/fonts/fontawesome/css/all.min.css')}}">
@endsection
  ...
  <div class="card">
    <div class="card-content">
      ...
      <p>
        ...
        <a href="{{asset('marbia/marbia-crm/public/css-color')}}" target="_blank"> css-color</a>.
      </p>
      <div class="row">
        <div class="col s12 m3">
          <div class="card gradient-shadow gradient-45deg-light-blue-cyan border-radius-3">
            <div class="card-content center">
              <img src="{{asset('marbia/marbia-crm/public/images/icon/apple-watch.png')}}" alt="images" class="width-40" />
        ...
        <div class="col s12 m3">
          <div class="card gradient-shadow gradient-45deg-red-pink border-radius-3">
            <div class="card-content center">
              <img src="{{asset('marbia/marbia-crm/public/images/icon/printer.png')}}" alt="images" class="width-40" />
        ...
        <div class="col s12 m3">
          <div class="card gradient-shadow gradient-45deg-amber-amber border-radius-3">
            <div class="card-content center">
              <img src="{{asset('marbia/marbia-crm/public/images/icon/laptop.png')}}" alt="images" class="width-40" />
        ...
        <div class="col s12 m3">
          <div class="card gradient-shadow gradient-45deg-green-teal border-radius-3">
            <div class="card-content center">
              <img src="{{asset('marbia/marbia-crm/public/images/icon/bowling.png')}}" alt="images" class="width-40" />
  ...
  <div id="card-panel-type" class="section">
    ...
    <div class="row mt-2">
      <div class="col s12 m6 l4 card-width">
        <div class="card-panel border-radius-6 mt-10 card-animation-1">
          <img class="responsive-img border-radius-8 z-depth-4 image-n-margin"
            src="{{asset('marbia/marbia-crm/public/images/cards/news-fashion.jpg')}}" alt="images" />
          ...
          <div class="row mt-4">
            <div class="col s2">
              <a href="#"><img src="{{asset('marbia/marbia-crm/public/images/user/9.jpg')}}" width="40" alt="fashion"
      ...
      <div class="col s12 m6 l4 card-width">
        <div class="card-panel border-radius-6 mt-10 card-animation-1">
          <img class="responsive-img border-radius-8 z-depth-4 image-n-margin"
            src="{{asset('marbia/marbia-crm/public/images/cards/news-apple.jpg')}}" alt="images" />
          <h6><a href="#" class="mt-5">Apple News</a></h6>
          <p>More than 40% users have reported their new phones won't charge when plugged into
            lightning cables.</p>
          <div class="row mt-4">
            <div class="col s2">
              <a href="#"><img src="{{asset('marbia/marbia-crm/public/images/user/1.jpg')}}" width="40" alt="news"
                  class="circle responsive-img mr-3" /></a>
            </div>
            <a href="#">
      ...
      <div class="col s12 m6 l4 card-width">
        <div class="card-panel border-radius-6 mt-10 card-animation-1">
          <img class="responsive-img border-radius-8 z-depth-4 image-n-margin"
            src="{{asset('marbia/marbia-crm/public/images/cards/news-twitter.jpg')}}" alt="" />
    ...
    <div class="row">
      <div class="col s12 m6 l4 card-width">
        <div class="card card-border center-align gradient-45deg-indigo-purple">
          <div class="card-content white-text">
            ...
            <img class="responsive-img circle z-depth-4" width="100" src="{{asset('marbia/marbia-crm/public/images/user/6.jpg')}}" alt="" />
      ...
      <div class="col s12 m6 l4 card-width">
        <div class="card card-border center-align gradient-45deg-purple-deep-orange">
          <div class="card-content white-text">
            <div class="col s12"><i class="material-icons right">favorite</i></div>
            <img class="responsive-img circle z-depth-4" width="100" src="{{asset('marbia/marbia-crm/public/images/user/2.jpg')}}"
              alt="images" />
      ...
      <div class="col s12 m6 l4 card-width">
        <div class="card card-border center-align gradient-45deg-indigo-purple">
          <div class="card-content white-text">
            <div class="col s12"><i class="material-icons right">favorite</i></div>
            <img class="responsive-img circle z-depth-4" width="100" src="{{asset('marbia/marbia-crm/public/images/user/8.jpg')}}"
              alt="images" />
      ...
      <div class="col s12 m6 l4">
        <div class="card deep-purple">
          <div class="card-content white-text right-align pr-0">
            ...
            <img class="responsive-img" src="{{asset('marbia/marbia-crm/public/images/cards/camara.png')}}" alt="images" />
          </div>
      ...
      <div class="col s12 m6 l4">
        <div class="card red darken-2">
          <div class="card-content white-text right-align pr-0">
            ...
            <img class="responsive-img" src="{{asset('marbia/marbia-crm/public/images/cards/headphones.png')}}" alt="images" />
          </div>
          <div class="card-action pt-0">
            <p class="white-text">Default Quality</p>
        ...
        <div class="card black">
          <div class="card-content white-text right-align pr-0">
            <span class="card-title position-absolute">iPad</span> <img class="responsive-img"
              src="{{asset('marbia/marbia-crm/public/images/cards/ipad.png')}}" alt="images" />
          </div>
          <div class="card-action pt-0">
      ...
      <div class="col s12 m4">
        <div class="card gradient-45deg-light-blue-cyan">
          <div class="card-content white-text center">
            ...
            <img src="{{asset('marbia/marbia-crm/public/images/cards/watch.png')}}" alt="images" class="responsive-img" />
            <p>
              The Apple Watch, <br />
        ...
        <div class="card blue-grey darken-4">
          <div class="card-content white-text center">
            <span class="card-title blue-grey-text lighten-4 font-weight-400">The Asics
              Shoes</span>
            <img src="{{asset('marbia/marbia-crm/public/images/cards/shoes.png')}}" alt="images" class="responsive-img" />
      ...
      <div class="col s12 m4">
        <div class="card gradient-45deg-red-pink">
          <div class="card-content white-text center">
            ...
            <img src="{{asset('marbia/marbia-crm/public/images/cards/iphonec.png')}}" alt="images" class="responsive-img" />
            <p>
              The Apple iPhone, <br />
              all time witch will suit any time
            </p>
    ...
    <div class="row">
      <div class="col s12 m6">
        <div class="card">
          ...
          <div class="card-content">
            <div id="test4" class="center"><img src="{{asset('marbia/marbia-crm/public/images/cards/nike.png')}}" alt="images" /></div>
            <div id="test5" class="center"><img src="{{asset('marbia/marbia-crm/public/images/cards/puma.png')}}" alt="images" /></div>
            <div id="test6" class="center"><img src="{{asset('marbia/marbia-crm/public/images/cards/reebok.png')}}" alt="images" /></div>
          </div>
        </div>
      </div>
    </div>
...
<script src="{{asset('marbia/marbia-crm/public/fonts/fontawesome/js/all.min.js')}}"></script>
@endsection

{{-- page scripts --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/cards-extended.js')}}"></script>
