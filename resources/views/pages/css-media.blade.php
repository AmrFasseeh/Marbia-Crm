...
{{-- page style --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/css-media.css')}}">
@endsection
        ...
        <div class="card-content">
          ...
          <div id="view-images">
            <div class="row">
              ...
              <div class="col s12">
                <img class="responsive-img" src="{{asset('marbia/marbia-crm/public/images/gallery/44.jpg')}}" alt="style typography">
              ...
              <div class="col s12 m8 offset-m2 l6 offset-l3 mt-3 mb-3">
                <div class="grey lighten-5 z-depth-1">
                  <div class="row valign-wrapper">
                    <div class="col s2">
                      <img src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-4.png')}}" alt=""
