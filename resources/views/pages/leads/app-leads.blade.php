            ...
            <div class="col s6">
              <div class="input-field mt-0">
                ...
                <div class="display-flex">
                  <div class="avatar ">
                    <img src="{{asset('marbia/marbia-crm/public/images/avatar/avatar-11.png')}}" class="circle" height="36" width="36"
...
<script>
  $(document).ready(function () {
    ...
    window.location.href = SITEURL + '/app-leads-view/' + id;
    // // set edit title
