...
{{-- page styles --}}
@section('page-style')
<link rel="stylesheet" type="text/css" href="{{asset('marbia/marbia-crm/public/css/pages/charts-sparkline.css')}}">
@endsection
...
{{-- page scripts --}}
@section('page-script')
<script src="{{asset('marbia/marbia-crm/public/js/scripts/charts-sparklines.js')}}"></script>
@endsection